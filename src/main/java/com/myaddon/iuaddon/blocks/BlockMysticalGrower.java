...
public enum BlockMysticalGrower implements ITeBlock, ITeBlockSpecialItem {

    mystical_grower(TileEntityMysticalGrower.class, 0);

    public static final ResourceLocation IDENTITY = new ResourceLocation(IUAddon.MOD_ID, "mystical_grower");
    ...
    BlockMysticalGrower(final Class<? extends TileEntityBlock> teClass, final int itemMeta) {
        this(teClass, itemMeta, EnumRarity.UNCOMMON);
    }

    BlockMysticalGrower(final Class<? extends TileEntityBlock> teClass, final int itemMeta, final EnumRarity rarity) {
